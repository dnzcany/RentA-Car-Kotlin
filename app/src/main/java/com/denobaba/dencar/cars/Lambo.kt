...
import com.denobaba.dencar.databinding.ActivityFerrari458Binding
import com.denobaba.dencar.databinding.ActivityLamboBinding
import com.denobaba.dencar.purchase

class lambo : AppCompatActivity() {
    private lateinit var binding: ActivityLamboBinding
    var newPrice: Int = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //setContentView(R.layout.activity_lambo)
        binding = ActivityLamboBinding.inflate(layoutInflater)
