...
import com.denobaba.dencar.databinding.ActivityGmcsierraBinding
import com.denobaba.dencar.databinding.ActivityLamboBinding
import com.denobaba.dencar.purchase

class gmcsierra : AppCompatActivity() {
    private lateinit var binding: ActivityGmcsierraBinding
    var newPrice: Int = 0


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //setContentView(R.layout.activity_gmcsierra)
        binding = ActivityGmcsierraBinding.inflate(layoutInflater)
