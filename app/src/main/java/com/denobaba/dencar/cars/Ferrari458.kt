...
class ferrari458 : AppCompatActivity() {
    private lateinit var binding: ActivityFerrari458Binding
    var newPrice: Int = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //setContentView(R.layout.activity_ferrari458)
        binding = ActivityFerrari458Binding.inflate(layoutInflater)
